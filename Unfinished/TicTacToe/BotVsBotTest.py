...
def main():
    ...
    for i in range(100):
        print("------------------------------------------------------")
        player1Path = "exports/01-15-2025_05-04-05PM/Generation10000/Network" + str(i)
        player2Path = "exports/01-15-2025_05-04-05PM/Generation100/Network0"
        botPlayer1: TicTacToePlayer = TicTacToePlayer(AudensNeuralNetworkLibrary.NeuralNetwork.importFromJson(player1Path))
        botPlayer2: TicTacToePlayer = TicTacToePlayer(AudensNeuralNetworkLibrary.NeuralNetwork.importFromJson(player2Path))
        player1Points, player2Points = MatchUp.runMatchUp(botPlayer1,botPlayer2,100000,player1Path,player2Path)
